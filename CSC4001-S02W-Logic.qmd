...
## SR Latch with only NAND gates

**Question 1** Rebuild the below SR latch with only NAND gates.
...
**Question 2** Rebuild the below *gated* SR latch with only NAND gates.
...
Use the clock to generate signals.
