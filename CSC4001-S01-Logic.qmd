...
- Add two *Toggle Switches* as inputs and one *Light Bulb* as the
  output.
- Test out some logic gates -- connect the two inputs to the output
  using the **AND**, **OR**, **XOR**, **NOT**, **NAND** and **NOR**
  gates.
...
## Exercise: One gate in terms of another

Build the following:

- and **AND** gate using of only **NOT** and **OR**;
